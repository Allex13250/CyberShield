...
const _stylesFactory = (colors: any) => StyleSheet.create({
  ...
  heroCategory: { color: colors.cyan, letterSpacing: 1, fontWeight: "800", fontSize: 11 },
  ...
  pillText: { fontSize: 10, fontWeight: "800", letterSpacing: 0.4, fontFamily: "Courier" },
  card: {
  ...
  imageRow: { color: colors.textSecondary, marginTop: spacing.md, fontSize: 12 },
  imageKey: { color: colors.textMuted, fontFamily: "Courier" },
  imageVal: { color: colors.neonGreen, fontFamily: "Courier" },
  terminal: {
    marginTop: spacing.lg,
    backgroundColor: "#000",
    borderTopWidth: 1,
  ...
  terminalLine: { color: colors.terminalText, fontFamily: "Courier", fontSize: 12, lineHeight: 18 },
  terminalCursor: { color: colors.terminalText, fontFamily: "Courier", fontSize: 12 },
  primaryBtn: {
    marginTop: spacing.lg,
  ...
  actionBtnText: { fontWeight: "800", letterSpacing: 0.4, marginLeft: 6 },
  flagRow: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#000",
  ...
  flagInput: { flex: 1, color: colors.terminalText, fontFamily: "Courier", fontSize: 14 },
  submitBtn: {
  ...
  submitBtnText: { color: "#000", fontWeight: "800", letterSpacing: 0.4, marginLeft: 6 },
  completedBanner: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  completedText: { color: colors.neonGreen, fontWeight: "800", letterSpacing: 0.4, marginLeft: 6, fontSize: 12 },
});
